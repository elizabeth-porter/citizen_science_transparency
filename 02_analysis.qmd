...
**What is the frequency of transparent vs not transparent attribution cases for each citizen science project?** Ask Karl about simulated p value?
```{r}
...
```
**What do the publications look like over time?**
